...
//put data to database from backend
  ...
  <div className="form-row">
    <div className="form-group col-md-6">
      ...
      <input type="text" className="form-control" id="inputID" placeholder="Enter Supplier ID here" autocomplete="off"  onChange={(e)=>{
...
setID(e.target.value);
    ...
    <div className="form-group col-md-6">
      ...
      <input type="text" className="form-control" id="inputCompanyname" placeholder="Enter Company name here" autocomplete="off"   onChange={(e)=>{
...
setCompanyName(e.target.value);
  ...
  <div className="form-group">
    ...
    <input type="text" className="form-control" id="inputAddress" placeholder="Enter address here" autocomplete="off"  onChange={(e)=>{
...
setAddress(e.target.value);
  ...
  <div className="form-row">
    <div className="form-group col-md-6">
      ...
      <input type="text" className="form-control" id="inputphone" placeholder="Enter Company phone number here" autocomplete="off"   onChange={(e)=>{
...
setEmail(e.target.value);
  ...
  <div className="form-row">
    <div className="form-group col-md-6">
      ...
      <input type="text" className="form-control" id="inputContactname" placeholder='Enter name here' maxlength="10" autocomplete="off"   onChange={(e)=>{
...
setContactName(e.target.value);
    ...
    <div className="form-group col-md-4">
      ...
      <input type="text" className="form-control" id="inputMobile"placeholder='0778911672' autocomplete="off"   onChange={(e)=>{
...
setMobile(e.target.value);
    ...
    <div className="form-group col-md-2">
      ...
      <input type="text" className="form-control" id="inputType"placeholder='Type' autocomplete="off"  onChange={(e)=>{

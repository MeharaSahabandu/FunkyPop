...
export default function AddStockO (){
 ...
 axios.post("http://localhost:8070/stockorder/add",newStockOrder).then(()=>{
   /*  Navigate('/') */
...
setID(e.target.value);
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="inputOrederNo"  name="orderNumber"  autocomplete="off" placeholder="Enter Order Number here" onChange={(e)=>{
...
setOrderNumber(e.target.value);
    ...
    <div class="form-group col-md-6">
      ...
      <input type="date" class="form-control" id="inputdate" name="date" min="2021-01-01"   autocomplete="off" onChange={(e)=>{
...
setDate(e.target.value);
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="inputDes"  name="description"   autocomplete="off" placeholder="Enter Description here" onChange={(e)=>{
...
setDes(e.target.value);
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="inputStatus"  name="status"  autocomplete="off" placeholder="Status" onChange={(e)=>{

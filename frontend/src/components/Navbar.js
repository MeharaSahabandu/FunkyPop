    ...
    return(
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        ...
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="/addsup">Register a new Supplier<span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item active">
            <a class="nav-link" href="/viewSupplier">View Supplier list <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item active">
